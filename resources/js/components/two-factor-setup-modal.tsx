    ...
    const modalConfig = useMemo<{
        ...
        if (twoFactorEnabled) {
            return {
                ...
                description:
                    'A autenticação de dois fatores foi ativada. Escaneie o QR Code ou informe a chave de configuração no seu aplicativo autenticador.',
                buttonText: 'Fechar',
            };
        }
        ...
        return {
            ...
            description:
                'Para concluir a ativação da autenticação de dois fatores, escaneie o QR Code ou informe a chave de configuração no seu aplicativo autenticador',
            buttonText: 'Continuar',
        };
